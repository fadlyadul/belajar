    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ($jumlah>0){
            if ($row["status"]==1){
                ...
                $_SESSION["is_first_admin"]=$row["is_first_admin"];
            ...
            <div class="col-sm-5">
                <form action="index.php?halaman=login" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="username" placeholder="Masukan username" required oninvalid="this.setCustomValidity('Username wajib diisi')" oninput="setCustomValidity('')">
                    </div>
                    <div class="form-group">
                        <label for="pwd">Password:</label>
                        <input type="password" name="password" class="form-control" placeholder="Masukan password" required oninvalid="this.setCustomValidity('Password wajib diisi')" oninput="setCustomValidity('')">
                    </div>
