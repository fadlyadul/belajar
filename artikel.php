        ...
        <div class="thumbnail">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a>Di upload tanggal: <?php echo $data["tanggal"];?></a></li>
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="caption">
                        ...
                        <div class="row">
                            <div class="col-sm-1">
                                <img src="gambar/profile.jpg" width="100%" alt="Cinque Terre">
                            </div>
                            <div class="col-sm-11">
            ...
            <div class="comment">
                <form method="post" action="simpan-komentar.php">
                    ...
                    <div class="form-group">
                        <label>Nama:</label>
                        <input type="text" name="nama" class="form-control" required oninvalid="this.setCustomValidity('Wajib isi nama')" oninput="setCustomValidity('')">
                    </div>
                    <div class="form-group">
                        <label>Email:</label>
                        <input type="email" name="email" class="form-control" required oninvalid="this.setCustomValidity('Wajib isi Email')" oninput="setCustomValidity('')">
                    </div>

                    <div class="form-group">
                        <label>Komentar:</label>
                        <textarea class="form-control" name="komentar" rows="5" required></textarea>
                    </div>
                    <div class="form-group">
