<div class="card mb-4">
    ...
    <div class="card-body">
        <div class="card-columns">
            ...
            $no++;
            ?>
            <div class="card bg-basic" style="width: 12rem; height:15rem;">
            <a href="index.php?halaman=artikel&kategori=<?php echo $data['id_kategori'];?>"><img class="card-img-top" src="artikel/gambar_kategori/<?php echo $data['gambar_kategori'];?>" width="100%" height="115px" alt="Card image cap"></a>
