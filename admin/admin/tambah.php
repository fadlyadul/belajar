...
?>
    <form action="admin/tambah.php" method="post">
        ...
        <div class="form-group">
            ...
            <input name="is_first_admin" type="text" class="form-control" placeholder="Masukan level" required>
        </div>
        <div class="form-group">
...
<?php
    if (isset($_POST['simpan_tambah'])) {
        ...
        $is_first_admin=input($_POST["is_first_admin"]);
        ...
        $sql="insert into pengguna (kode_pengguna,nama_pengguna,email,username,password,status) values
        ('$kode_pengguna','$is_first_admin','$nama_pengguna','$email','$username','$password','$status')";
